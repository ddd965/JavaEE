...
import com.example.javaee_ecomorder.common.basic.OrderStatusEnum;
...
import com.example.javaee_ecomorder.common.entity.Order;
...
import com.example.javaee_ecomorder.common.utils.OrderNoGenerator;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDetailVO getOrderDetail(Long orderId) {
        ...
        if (withProducts != null && withProducts.getProducts() != null) {
            for (com.example.javaee_ecomorder.common.vo.OrderProductVO p : withProducts.getProducts()) {
